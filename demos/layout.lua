...
local autocomplete = ui.SmartMenu({ "foo", "bar", "A long option", "Another long one", "yyy", "xyz" }, { top = 2, height = 5, bg = tb.CYAN })
left:add(autocomplete)

local menu_right = ui.SmartMenu({ "foo", "bar", "A long option", "Another long one", "yyy", "xyz" }, { placeholder = " Choose ", horizontal_pos = "right", top = 4, right = 2, height = 5, bg = tb.CYAN })
left:add(menu_right)
