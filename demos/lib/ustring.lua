-- from https://github.com/wikimedia/mediawiki-extensions-Scribunto/blob/master/includes/engines/LuaCommon/lualib/ustring/ustring.lua
...
function ustring.replaceEmoji(s, toChar)
  ...
  local chars = {}
  for cp in ustring.gcodepoint(s) do
    table.insert(chars, isEmoji(cp) and toChar or ustring.char(cp))
  end
